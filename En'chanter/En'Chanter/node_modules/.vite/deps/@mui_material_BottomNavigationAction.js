...
function createGrid(options = {}) {
  ...
  const GridOverflowContext = React18.createContext(void 0);
  if (true) {
  ...
  const Grid2 = React18.forwardRef(function Grid3(inProps, ref) {
    ...
    const overflow2 = React18.useContext(GridOverflowContext);
    const {
      className,
      children: children2,
    ...
    let result = (0, import_jsx_runtime9.jsx)(GridRoot, _extends({
      ...
      children: React18.Children.map(children2, (child) => {
...
function joinChildren(children2, separator) {
  const childrenArray = React19.Children.toArray(children2).filter(Boolean);
...
var TouchRipple = React21.forwardRef(function TouchRipple2(inProps, ref) {
  ...
  return (0, import_jsx_runtime12.jsx)(TouchRippleRoot, _extends({
...
var ButtonBase = React22.forwardRef(function ButtonBase2(inProps, ref) {
  ...
  return (0, import_jsx_runtime14.jsxs)(ButtonBaseRoot, _extends({
    as: ComponentProp,
    className: clsx_default(classes.root, className),
    ownerState,
    onBlur: handleBlur,
    ...
    children: [children2, enableTouchRipple ? (
      ...
      (0, import_jsx_runtime13.jsx)(TouchRipple_default, _extends({
        ref: handleRippleRef,
        center: centerRipple
      }, TouchRippleProps))
    ) : null]
